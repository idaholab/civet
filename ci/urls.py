...
urlpatterns = [
    ...
    url(r'^git_events/$', views.view_git_events, name='view_git_events'),
    url(r'^retry_git_events/(?P<git_event_id>[0-9]+)/$', views.retry_git_event, name='retry_git_event'),
    ...
    url(r'^profile/(?P<server_type>[0-9]+)/(?P<server_name>[A-Za-z0-9_.-]+)/$', views.view_profile, name='view_profile'),
