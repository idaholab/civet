...
class Tests(RecipeTester.RecipeTester):
    def test_write(self):
        ...
        self.create_recipe_in_repo("recipe_push.cfg", "push_dep.cfg")
        self.create_recipe_in_repo("recipe_pr.cfg", "pr_dep.cfg")
        ...
        self.assertTrue(RecipeWriter.write_recipe_to_repo(self.recipes_dir, r, "new_file.cfg"))
        reader = RecipeReader(self.recipes_dir, "new_file.cfg")
        r = reader.read()
