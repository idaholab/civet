...
def convert_recipe(args):
    ...
    parser.add_argument(
        "--recipe", dest="recipe", help="The recipe file to convert.", required=True
    )
    ...
    parser.add_argument(
        ...
        dest="build_root",
        default="/tmp/",
        help="Where to set BUILD_ROOT",
    )
    parser.add_argument(
        "--num-jobs", dest="num_jobs", default="4", help="What to set MOOSE_JOBS to"
    )
    parser.add_argument(
        "--head",
        nargs=3,
        dest="head",
        help="Head repo to work on. Format is: repo branch sha",
        required=True,
    )
    parser.add_argument(
        "--base",
        nargs=3,
        dest="base",
        help="Base repo to work on. Format is: repo branch sha",
        required=True,
    )
