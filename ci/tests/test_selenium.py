...
class Tests(SeleniumTester.SeleniumTester):
  ...
  def test_job_cancel(self):
    self.assertFalse("Need tests")

  @SeleniumTester.test_drivers()
  def test_job_cancel_invalid(self):
    self.assertFalse("Need tests")
  ...
  @SeleniumTester.test_drivers()
  def test_job_invalidate(self):
    self.assertFalse("Need tests")

  @SeleniumTester.test_drivers()
  def test_job_invalidate_invalid(self):
    self.assertFalse("Need tests")

  @SeleniumTester.test_drivers()
  def test_job_invalidate_valid(self):
    self.assertFalse("Need tests")

  @SeleniumTester.test_drivers()
  def test_job_invalidate_while_running(self):
    self.assertFalse("Need tests")
